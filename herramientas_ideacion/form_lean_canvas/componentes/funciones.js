...
document.addEventListener('DOMContentLoaded', function() {
  ...
  btnSiguiente.addEventListener('click', function() {
    ...
    if (nombreProyecto && nombreProyecto.value.trim()) {
      ...
      contenedor.textContent = 'Proyecto: ' + nombreProyecto.value;
    }
  });
});


      // Lógica de navegación entre momentos y barra de progreso
      const btnSiguiente = document.getElementById('siguiente');
